        ...
        <nav className="w-full bg-gray-800">
            ...
            <div className="md:hidden" id="mobile-menu">
                <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    <Link href="/" className={`${pathname == "/" ? "nav-active" : "nav-not-active"} bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium`}>Laporkan</Link>
                    <Link href="/lihat" className={`${pathname == "/lihat" ? "nav-active" : "nav-not-active"} text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium`}>Lihat Laporan</Link>
                </div>
            </div>
      </nav>
    )
